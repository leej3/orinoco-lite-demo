...
Keep released scaffold maintenance separate from the site's data, policy,
presentation choices, source configuration, curation decisions, and
...
- Review locks, site-owned files, conflicts, and the final diff before
